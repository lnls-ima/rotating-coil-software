...
list_fap_soft_interlocks = ['DCCT 1 Fault', 'DCCT 2 Fault',
                            'DCCT High Difference', 'Load Feedback 1 Fault',
                            'Load Feedback 2 Fault',
                            'IGBTs Current High Difference']
list_fap_hard_interlocks = ['Load Overcurrent', 'Load Overvoltage',
                            'DCLink Overvoltage', 'DCLink Undervoltage',
                            'DCLink Contactor Fault', 'IGBT 1 Overcurrent',
                            'IGBT 2 Overcurrent']

list_fap_225A_soft_interlocks = ['IGBTs Current High Difference']
list_fap_225A_hard_interlocks = ['Load Overcurrent', 'DCLink Contactor Fault', 
                                 'IGBT 1 Overcurrent','IGBT 2 Overcurrent']
...
#        return self.ser.read()
    ...
    def sync_pulse(self):
        payload_size = self.size_to_hex(1) #Payload: ID
        send_packet  = self.ComFunction+payload_size+self.index_to_hex(
            ListFunc_v2_1.index('sync_pulse'))
        send_msg     = self.checksum(self.SlaveAdd+send_packet)
        self.ser.write(send_msg.encode('ISO-8859-1'))
        return self.ser.read(6)
    ...
    def set_serial_termination(self,term_enable):
        ...
        send_packet  = self.ComFunction+payload_size+self.index_to_hex(
            ListFunc_v2_1.index('set_serial_termination'))+hex_enable
        send_msg     = self.checksum(self.SlaveAdd+send_packet)
        self.ser.write(send_msg.encode('ISO-8859-1'))
        return self.ser.read(6)
    ...
    def cfg_siggen(self, sig_type, num_cycles, freq, amplitude, offset, aux0,
        ...
        send_packet = (self.ComFunction + payload_size +
            ...
            hex_sig_type + hex_num_cycles + hex_freq + hex_amplitude +
            hex_offset + hex_aux0 + hex_aux1 + hex_aux2 + hex_aux3)
        send_msg = self.checksum(self.SlaveAdd + send_packet)
        self.ser.write(send_msg.encode('ISO-8859-1'))
        return self.ser.read(6)
    ...
    def enable_siggen(self):
        ...
        payload_size = self.size_to_hex(1)
        send_packet = (self.ComFunction+payload_size +
            self.index_to_hex(ListFunc_v2_1.index('enable_siggen')))
        send_msg = self.checksum(self.SlaveAdd + send_packet)
        self.ser.write(send_msg.encode('ISO-8859-1'))
        return self.ser.read(6)
    ...
    def disable_siggen(self):
        ...
        payload_size = self.size_to_hex(1)
        send_packet = (self.ComFunction+payload_size +
            self.index_to_hex(ListFunc_v2_1.index('disable_siggen')))
        send_msg = self.checksum(self.SlaveAdd + send_packet)
        self.ser.write(send_msg.encode('ISO-8859-1'))
        return self.ser.read(6)
    ...
    def Recv_samplesBuffer_blocks(self,block_idx):
        ...
        payload_size = self.size_to_hex(1+2)
        send_packet = (self.ComRequestCurve + payload_size +
            self.index_to_hex(ListCurv.index('samplesBuffer_blocks')) +
            block_hex)
        send_msg = self.checksum(self.SlaveAdd + send_packet)
        self.ser.write(send_msg.encode('ISO-8859-1'))
        #Address+Command+Size+ID+Block_idx+data+checksum
    ...
    def read_vars_fbp_dclink(self):
    
        self.read_vars_common()
        
        print("\nInterlocks: " + str(self.read_bsmp_variable(26, 'uint32_t')))
        ...
        print("Dig Pot Tap: " + str(self.read_bsmp_variable(32, 'uint8_t')))

    def read_vars_fac_acdc(self):
    ...
    def read_vars_fac_dcdc(self):
        ...
        print("Temp IGBT: " +
              str(self.read_bsmp_variable(32, 'float')))
        print("Duty-Cycle: " + str(self.read_bsmp_variable(33, 'float')))
    ...
    def read_vars_fac_2p4s_dcdc(self, n=1, com_add=1, dt=0.5):
        ...
        try:
            for i in range(n):
                ...
                print("\nLoad Current 1: " + str(self.read_bsmp_variable(27,'float')))
                print("Load Current 2: " + str(self.read_bsmp_variable(28,'float')))
                print("Load Voltage: " + str(self.read_bsmp_variable(29,'float')))
                
                print("\nArm Current 1: " + str(self.read_bsmp_variable(54,'float')))
                print("Arm Current 2: " + str(self.read_bsmp_variable(55,'float')))
                
                print("\nCapBank Voltage 1: " + str(self.read_bsmp_variable(30,'float')))
                print("CapBank Voltage 2: " + str(self.read_bsmp_variable(31,'float')))
                print("CapBank Voltage 3: " + str(self.read_bsmp_variable(32,'float')))
                print("CapBank Voltage 4: " + str(self.read_bsmp_variable(33,'float')))
                print("CapBank Voltage 5: " + str(self.read_bsmp_variable(34,'float')))
                print("CapBank Voltage 6: " + str(self.read_bsmp_variable(35,'float')))
                print("CapBank Voltage 7: " + str(self.read_bsmp_variable(36,'float')))
                print("CapBank Voltage 8: " + str(self.read_bsmp_variable(37,'float')))
                
                print("\nModule Output Voltage 1: " + str(self.read_bsmp_variable(38,'float')))
                print("Module Output Voltage 2: " + str(self.read_bsmp_variable(39,'float')))
                print("Module Output Voltage 3: " + str(self.read_bsmp_variable(40,'float')))
                print("Module Output Voltage 4: " + str(self.read_bsmp_variable(41,'float')))
                print("Module Output Voltage 5: " + str(self.read_bsmp_variable(42,'float')))
                print("Module Output Voltage 6: " + str(self.read_bsmp_variable(43,'float')))
                print("Module Output Voltage 7: " + str(self.read_bsmp_variable(44,'float')))
                print("Module Output Voltage 8: " + str(self.read_bsmp_variable(45,'float')))
    ...
    def read_vars_fap(self, n = 1, com_add = 1, dt = 0.5, iib = 1):
        ...
        try:
            for i in range(n):
                ...
                print("\nLoad Current 1: " + str(self.read_bsmp_variable(27,'float')) + " A")
                print("Load Current 2: " + str(self.read_bsmp_variable(28,'float')) + " A")
                print("\nDC-Link Voltage: " + str(self.read_bsmp_variable(29,'float')) + " V")
                print("\nIGBT 1 Current: " + str(self.read_bsmp_variable(30,'float')) + " A")
                print("IGBT 2 Current: " + str(self.read_bsmp_variable(31,'float')) + " A")
                print("\nIGBT 1 Duty-Cycle: " + str(self.read_bsmp_variable(32,'float')) + " %")
                print("IGBT 2 Duty-Cycle: " + str(self.read_bsmp_variable(33,'float')) + " %")
                print("Differential Duty-Cycle: " + str(self.read_bsmp_variable(34,'float')) + " %")
                
                if(iib):
                    print("\nIIB Input Voltage: " + str(self.read_bsmp_variable(35,'float')) + " V")
                    print("IIB Output Voltage: " + str(self.read_bsmp_variable(36,'float')) + " V")
                    print("IIB IGBT 1 Current: " + str(self.read_bsmp_variable(37,'float')) + " A")
                    print("IIB IGBT 2 Current: " + str(self.read_bsmp_variable(38,'float')) + " A")
                    print("IIB IGBT 1 Temp: " + str(self.read_bsmp_variable(39,'float')) + " ºC")
                    print("IIB IGBT 2 Temp: " + str(self.read_bsmp_variable(40,'float')) + " ºC")
                    print("IIB Driver Voltage: " + str(self.read_bsmp_variable(41,'float')) + " V")
                    print("IIB Driver Current 1: " + str(self.read_bsmp_variable(42,'float')) + " A")
                    print("IIB Driver Current 2: " + str(self.read_bsmp_variable(43,'float')) + " A")
                    print("IIB Inductor Temp: " + str(self.read_bsmp_variable(44,'float')) + " ºC")
                    print("IIB Heat-Sink Temp: " + str(self.read_bsmp_variable(45,'float')) + " ºC")
                    print("IIB External Interlock: " + str(self.read_bsmp_variable(46,'float')))
                    print("IIB Leakage Interlock: " + str(self.read_bsmp_variable(47,'float')))
                    print("IIB Rack Interlock: " + str(self.read_bsmp_variable(48,'float')))                
                time.sleep(dt)
    ...
    def read_vars_fap_225A(self, n = 1, com_add = 1, dt = 0.5):
        ...
        try:
            for i in range(n):
                ...
                print("\nIGBT 1 Current: " + str(self.read_bsmp_variable(28,'float')) + " A")
                print("IGBT 2 Current: " + str(self.read_bsmp_variable(29,'float')) + " A")
                print("\nIGBT 1 Duty-Cycle: " + str(self.read_bsmp_variable(30,'float')) + " %")
                print("IGBT 2 Duty-Cycle: " + str(self.read_bsmp_variable(31,'float')) + " %")
                print("Differential Duty-Cycle: " + str(self.read_bsmp_variable(32,'float')) + " %")
