...
class Ui_Pop_Up(object):
    def setupUi(self, Pop_Up):
        ...
        self.label_166.setGeometry(QtCore.QRect(67, 80, 91, 41))
        self.label_166.setObjectName("label_166")
        self.le_temperature = QtWidgets.QLineEdit(Pop_Up)
        self.le_temperature.setGeometry(QtCore.QRect(167, 90, 161, 21))
        ...
        self.label_167.setGeometry(QtCore.QRect(107, 110, 51, 41))
        self.label_167.setObjectName("label_167")
        self.cb_operator = QtWidgets.QComboBox(Pop_Up)
        self.cb_operator.setGeometry(QtCore.QRect(167, 120, 161, 22))
        ...
        self.label_49.setGeometry(QtCore.QRect(77, 150, 81, 25))
        ...
        self.cb_magnet_model.setGeometry(QtCore.QRect(167, 150, 161, 25))
        ...
        self.cb_magnet_model.addItem("")
        self.cb_magnet_model.addItem("")
        self.dateTime = QtWidgets.QDateTimeEdit(Pop_Up)
        self.dateTime.setGeometry(QtCore.QRect(170, 190, 161, 21))
        self.dateTime.setCalendarPopup(True)
        self.dateTime.setTimeSpec(QtCore.Qt.LocalTime)
        self.dateTime.setObjectName("dateTime")
        self.label_50 = QtWidgets.QLabel(Pop_Up)
        self.label_50.setGeometry(QtCore.QRect(67, 184, 91, 31))
    ...
    def retranslateUi(self, Pop_Up):
        ...
        Pop_Up.setWindowTitle(_translate("Pop_Up", "Form"))
        self.label.setText(_translate("Pop_Up", "Measurement features"))
        self.label_134.setText(_translate("Pop_Up", "Name:"))
        ...
        self.label_50.setText(_translate("Pop_Up", "Date and Time:"))
