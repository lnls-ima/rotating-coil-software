...
##            print(reshape)
    ...
    ##                QtGui.QApplication.processEvents()
                ...
                if self.ui.cb_DCCT.isChecked():
                    ...
                    self.ui.label_161.setEnabled(True)
                    self.ui.label_164.setEnabled(True)
##                    corrente4 = round(self.ConverteDCCT2(), 3)        # Original
                    corrente4 = round(self.ConverteDCCT(), 3)           # Para a fonte digital de 225 A (cabeça do DCCT de 160A)
...
##            ordens = numpy.append(ordens, float(v_Nn))
##            ordens = numpy.append(ordens, float(v_Sn))
##        calc_X = ordens[0]/ordens[2]/1e-06              #cálculo deslocamento X
##        calc_Y = ordens[1]/ordens[2]/1e-06              #cálculo deslocamento Y
##        self.ui.desl_X.setText(str(calc_X))
##        self.ui.desl_Y.setText(str(calc_Y))
...
##                saida.append(lib.Janela.ConverteDCCT2())  # Original
                saida.append(lib.Janela.ConverteDCCT())     # Modificado para a fonte 225A monopolar que está com a cabeça do DCCT de 160A
                time.sleep((1/self.velocidade)-0.01)
            self.saida = saida
